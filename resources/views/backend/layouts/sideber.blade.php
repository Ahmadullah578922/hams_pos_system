        ...
        <li class="nav-item {{($prefix=='/purchase')?'menu-open':''}}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="{{route('purchase.daily.report')}}" class="nav-link {{($route=='purchase.daily.report')?'active':''}}">
                        <i class="far fa-circle nav-icon"></i>
         ...
         <li class="nav-item {{($prefix=='/invoice')?'menu-open':''}}">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                    <a href="{{route('invoice.print.list')}}" class="nav-link {{($route=='invoice.print.list')?'active':''}}"> <i class="far fa-circle nav-icon"></i>
                        <p>Print Invoice</p>
                    </a>
                </li>
                <li class="nav-item">
